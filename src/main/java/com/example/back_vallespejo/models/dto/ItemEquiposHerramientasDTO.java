...
public class ItemEquiposHerramientasDTO {
    ...
    public Double getPrecioUnitario() { return precioUnitarioRecurso; }
    public void setPrecioUnitario(Double precioUnitario) { this.precioUnitarioRecurso = precioUnitario; }
